...
/* @Login/login.twig */
class __TwigTemplate_38354cc55594ba3e100171363632397d extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_loginContent($context, array $blocks = [])
    {
        ...
        ";
        // line 6
        yield from         $this->loadTemplate("@Login/login.twig", "@Login/login.twig", 6, "2060032748")->unwrap()->yield(CoreExtension::merge($context, ["title" => $this->env->getFilter('translate')->getCallable()("Login_LogIn")]));
        // line 74
        yield "    </div>
    <div class=\"contentForm resetForm\" style=\"display:none;\">
        ";
        // line 76
        yield from         $this->loadTemplate("@Login/login.twig", "@Login/login.twig", 76, "1011379610")->unwrap()->yield(CoreExtension::merge($context, ["title" => $this->env->getFilter('translate')->getCallable()("Login_ChangeYourPassword")]));
        // line 131
        yield "    </div>
...
{% endblock %}", "@Login/login.twig", "C:\\xampp\\htdocs\\webTrafficAnalysis\\analytics\\plugins\\Login\\templates\\login.twig");
    }
}


/* @Login/login.twig */
class __TwigTemplate_38354cc55594ba3e100171363632397d___2060032748 extends Template
{
    private $source;
    private $macros = [];
...
/* @Login/login.twig */
class __TwigTemplate_38354cc55594ba3e100171363632397d___1011379610 extends Template
{
    private $source;
    private $macros = [];
