...
class __TwigTemplate_5822c019e4faa1398169d12f0a085ddb extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        return new Source("<br />{{ 'GeoIp2_GeoIPVariablesConfigurationHere'|translate('<a href=\"' ~ configUrl|e('html_attr') ~ '\">', '</a>')|raw }}", "@GeoIp2/serverModule.twig", "C:\\xampp\\htdocs\\webTrafficAnalysis\\analytics\\plugins\\GeoIp2\\templates\\serverModule.twig");
    }
}
