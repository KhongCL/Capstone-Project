...
class __TwigTemplate_135d2185a0391abc361aeaaf4d55a8bf extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    ...
    <link rel=\"icon\" type='image/png' sizes='256x256' href=\"plugins/CoreHome/images/applogo_256.png\"/>
{% endif %}", "@CoreHome/_favicon.twig", "C:\\xampp\\htdocs\\webTrafficAnalysis\\analytics\\plugins\\CoreHome\\templates\\_favicon.twig");
    }
}
