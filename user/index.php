        ...
        <main>
            ...
            <section class="dashboard-links">
                ...
                <div class="dashboard-cards">
                    ...
                    <div class="card">
                        <h3>Top Pages</h3>
                        <p>See which pages are performing best on your website.</p>
                        <a href="pages.php" class="btn">Go to Top Pages</a>
                    </div>
                    <div class="card">
                        <h3>Compare Data</h3>
                        <p>Compare analytics data between different time periods.</p>
                        <a href="compare.php" class="btn">Go to Compare</a>
                    </div>
                </div>
            </section>
        </main>
